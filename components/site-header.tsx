    ...
    <header className="site-header sticky top-0 z-50 relative border-b border-white/8 bg-[#080c15]/72 backdrop-blur-2xl">
      ...
      <Container className="flex items-center justify-between py-4">
        <Link href="/" className="flex items-center gap-3">
          <div className="relative flex h-11 w-11 items-center justify-center rounded-2xl border border-white/12 bg-white/8 shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_16px_40px_rgba(0,0,0,0.35)]">
            <div className="absolute inset-1 rounded-[0.9rem] bg-[linear-gradient(135deg,rgba(77,162,255,0.9),rgba(124,92,255,0.9))]" />
            <span className="relative text-sm font-black tracking-[0.18em] text-white">BR</span>
          </div>
          <div>
            <p className="text-sm font-semibold tracking-tight text-white">Backgammon Rush</p>
            <p className="text-xs text-muted">Cinematic strategy platform</p>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-2">
          <div className="hidden items-center gap-2 rounded-full border border-white/10 bg-white/6 px-3 py-2 text-[0.65rem] uppercase tracking-[0.24em] text-muted md:flex">
            Live
